...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TestProject@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TestProject API";

        private String description = "TestProject API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TestProject";
